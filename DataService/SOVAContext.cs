...
namespace DataService
{
    ...
    public class SovaContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // Table SovaUsers
            modelBuilder.Entity<User>().ToTable("sovausers");
            ...
            modelBuilder.Entity<User>().Property(x => x.PasswordHash).HasColumnName("passwordhash");
            modelBuilder.Entity<User>().Property(x => x.PasswordSalt).HasColumnName("passwordsalt");
