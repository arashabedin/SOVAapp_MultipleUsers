...
namespace DataService.DataAccessLayer
{
    public interface IRepository
    {
        ...
        //UserCustomeField
        void AddUserCustomeField(string userName ,int postLimit, string tags);
        Boolean DeleteUserCustomeField(int id);
        UserCustomeFieldDTO GetUserCustomeFieldById(int id);
        UserCustomeFieldDTO GetLatestUserCustomeField(int userId);
      ...
      //ICollection<TermAsResultDTO> GetTermsAsResult(string text , int page, int pageSize);
        ...
        User GetById(int id);
        User CreateSovaUser(User user, string password);
        void UpdateSovaUser(User user, string password = null);
        void Delete(int id);
